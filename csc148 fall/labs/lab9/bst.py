...
class BinarySearchTree:
    ...
    def height(self) -> int:
        ...
        if self.is_empty():
            return 0
        return 1 + max(self._right.height(), self._left.height())
    ...
    def items_in_range(self, start: Any, end: Any) -> List:
        ...
        if self.is_empty():
            return []
        if self._root < start and self._right:
            return self._right.items_in_range(start, end)
        if self._root > end and self._left:
            ...
            if self._right:
                return [self._root] + self._right.items_in_range(start, end)
            if self._left:
    ...
    def rotate_right(self) -> None:
        ...
        <BLANKLINE>
        """
        if self.is_empty() or not self._left:
            return
        else:
            temp1, temp2, temp3, temp4 = \
                self._root, self._left._left, self._left._right, self._right
            self._root = self._left._root
            self._left = temp2
            self._right = BinarySearchTree(temp1)
            self._right._right, self._right._left = temp4, temp3
    ...
    def rotate_left(self) -> None:
        ...
        <BLANKLINE>
        """
        if self.is_empty() or not self._right:
            return
        else:
            temp1, temp2, temp3, temp4 = \
                self._root, self._right._left, self._right._right, self._left
            self._root = self._right._root
            self._right = temp3
            self._left = BinarySearchTree(temp1)
            self._left._right, self._left._left = temp2, temp4
